...
operar el Editor desde Codex.

## Estructura del repo

```
Back/GameServer/GameServer/   backend ASP.NET Core 8 + SignalR (única fuente de verdad de las reglas)
Front/game-client/            cliente web, React 19 + TS + Vite (ver Front/game-client/AGENTS.md)
UnityProject/PepinoUnity3D/   el proyecto Unity REAL (ver UnityProject/PepinoUnity3D/AGENTS.md)
...
- Unity MCP: en configuración (ver `UnityProject/PepinoUnity3D/AGENTS.md` para el estado exacto).
